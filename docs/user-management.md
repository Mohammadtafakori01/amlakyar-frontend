...
```javascript
fetch('http://185.215.244.196:3002/api/users?role=CONSULTANT', {
  headers: {
...
```javascript
fetch('http://185.215.244.196:3002/api/users/a2b16074-2c23-48f7-9cf2-a120a640d887', {
  headers: {
    'Authorization': 'Bearer <token>'
  }
})
...
```javascript
fetch('http://185.215.244.196:3002/api/users/staff', {
  method: 'POST',
  headers: {
...
```javascript
fetch('http://185.215.244.196:3002/api/users/me/profile', {
  headers: {
    'Authorization': 'Bearer <token>'
  }
})
